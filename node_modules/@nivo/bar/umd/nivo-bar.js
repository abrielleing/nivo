(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('d3-scale'), require('lodash/min'), require('lodash/max'), require('lodash/range'), require('lodash/flattenDepth'), require('d3-shape'), require('react'), require('prop-types'), require('recompose/compose'), require('recompose/withPropsOnChange'), require('recompose/pure'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/legends'), require('recompose/defaultProps'), require('react-motion'), require('recompose/setDisplayName')) :
    typeof define === 'function' && define.amd ? define(['exports', 'd3-scale', 'lodash/min', 'lodash/max', 'lodash/range', 'lodash/flattenDepth', 'd3-shape', 'react', 'prop-types', 'recompose/compose', 'recompose/withPropsOnChange', 'recompose/pure', '@nivo/core', '@nivo/axes', '@nivo/legends', 'recompose/defaultProps', 'react-motion', 'recompose/setDisplayName'], factory) :
    (factory((global.nivo = global.nivo || {}),global.d3,global['lodash/min'],global['lodash/max'],global['lodash/range'],global['lodash/flattenDepth'],global.d3,global.React,global.PropTypes,global.RecomposeCompose,global.RecomposeWithPropsOnChange,global.RecomposePure,global.nivo,global.nivo,global.nivo,global.RecomposeDefaultProps,global.ReactMotion,global.RecomposeSetDisplayName));
}(this, (function (exports,d3Scale,min,max,range,flattenDepth,d3Shape,React,PropTypes,compose,withPropsOnChange,pure,core,axes,legends,defaultProps,reactMotion,setDisplayName) { 'use strict';
